import TelosLogo from 'icons/shared_icon/telos_logo.icon.svg'
import HamburgerIcon from 'icons/shared_icon/hamburger.icon.svg'
import ArrowRight from 'icons/shared_icon/arrow_right.icon.svg'
